module.exports = function(kafka, async, _, Message, Publish) {
  ...
  var Middleware = function(options) {
    ...
    var client    = new kafka.Client(use_options.client.url, use_options.client.client_id, {}),
        ...
        publisher = Publish.generate(producer, _.defaults({verbose: use_options.verbose}, use_options.producer));
    ...
    var middleware = function(req, res, next) {
      ...
      if (use_options.message && _.isFunction(use_options.message)) {
        ...
        Message.generate(use_options.messages, req, res, send);
      }
    }
